...
| Step 3b output doesn't match contract | Model regression — prompt isn't being followed | Re-pull the model or pin a different one in the Aspire host fixture |
